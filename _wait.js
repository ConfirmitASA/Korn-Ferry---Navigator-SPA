...
<div id="did-you-know" style="opacity: 0; width: 50vw; min-width: 600px; filter: drop-shadow(20px 20px 20px black); position: absolute; color: black; padding: 50px;">
    <div style="background-color: #f0f0f0; color: #333; margin: 20px 0; padding: 50px; border-radius: 15px">
        <div class=loader>Loading...</div>
        <h1 style="font-weight: 200; font-size: 40px">${tip.Title}</h1>
        <br>
        <h3 class="tip-text" style="line-height: 24px; color: black; font-weight: 400">${tip.Text}</h3>
        <p style="color: #999">
