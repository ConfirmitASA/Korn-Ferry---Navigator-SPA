...
<div style="text-align: center; color: white;">
  ...
  <div class="action" id="wait-close" style="display:none; position: absolute; opacity: 0; top: 75vh; padding: 20px; width: 300px; height: 60px; right: 10vw; top: 75vh;">
    ${button_text}
  </div>
...
-->
  ...
  $('#movie3')
    ...
    .velocity({opacity:0}, {duration: 1000, delay: 3000})
    .velocity({display:'none'}, {duration: 1000, delay: 0, complete: function() { $('#wait-close').click(); }});


  $('.forstalogo').velocity({opacity:1}, {duration: 1000, delay: 17000});


  //$('#wait-close').velocity( {opacity: 1}, {duration: 1000, delay: 19000} );
