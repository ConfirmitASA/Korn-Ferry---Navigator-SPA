...
function Slideshow_Render() {
	...
	return `
	<div class="pageheader">Slideshow.</div>
	<div class="pagecontainer" id="pagecontainer-3">
		...
		<div class="greenareatext">
			The slideshow contains a curated set of slides based on the survey findings.<p>The same content is available as a downloadable PowerPoint presentation.
			</p>
			<div id="start_slideshow" style="margin-top: 10px; color: #77bc1f !important;">Start Slideshow ></div>
		</div>
