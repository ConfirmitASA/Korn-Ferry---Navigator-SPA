...
if (meta == null) {
	...
	meta = {
		...
		Labels: {
			...
			"KeyMetrics_MoreCardText.DIM_N64": {"Label": "Resources intro text"},
			"KeyMetrics_MoreCardText.DIM_N50": {"Label": "Authority & Empowerment intro text"},
			"KeyMetrics_MoreCardText.DIM_N65": {"Label": "Respect & Recognition intro text"},
			"KeyMetrics_MoreCardText.DIM_N52": {"Label": "Collaboration intro text"},
			"KeyMetrics_MoreCardText.DIM_N63": {"Label": "Quality & Customer Focus intro text"},
			"KeyMetrics_MoreCardText.DIM_N61": {"Label": "Performance Management intro text"},
			"KeyMetrics_MoreCardText.DIM_N54": {"Label": "Development Opportunities intro text"},
			"KeyMetrics_MoreCardText.DIM_N53": {"Label": "Confidence in Leaders intro text"},
			"KeyMetrics_MoreCardText.DIM_N66": {"Label": "Training intro text"},
			"KeyMetrics_MoreCardText.DIM_N51": {"Label": "Clear & Promising Direction intro text"},
			"KeyMetrics_MoreCardText.DIM_N67": {"Label": "Work, Structure, & Process intro text"},
			"KeyMetrics_MoreCardText.DIM_N60": {"Label": "Pay & Benefits intro text"},
			"KeyMetrics_MoreCardText.DIM_C15": {"Label": "Local questions intro text"},
			"KeyMetrics_MoreCardText.DIM_NPS": {"Label": "Employee Net Promoter Score (ENPS) intro text"},
